...
# ====================== Model Config ===========================
parser.add_argument('--llm_model', default='Qwen/Qwen-VL-Chat', help='LLM to use, meta-llama/Llama-2-7b-chat-hf')
...
parser.add_argument('--learning_rate', default=0.00002, type=float, metavar='LR', help='initial learning rate')
parser.add_argument('--max_length', default=300, type=int, metavar='N', help='Maximum length to truncate captions / generations to.')
...
parser.add_argument('--max_steps', default=15000000, type=int, metavar='N', help='Stop training after this number of steps. ')
